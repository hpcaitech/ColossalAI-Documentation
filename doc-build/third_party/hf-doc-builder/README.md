...
**This third-party repository is modified from the original [Huggingface Doc-Builder](https://github.com/huggingface/doc-builder) to enable autodoc for React+MDX in Docusaurus. We would like to credit the Hugging Face team for their wonderful work.**
