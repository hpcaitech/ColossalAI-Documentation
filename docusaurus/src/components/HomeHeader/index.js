  ...
  return (
    <div className="tw-relative tw-isolate tw-bg-white">
      ...
      <div className="tw-relative tw-px-6 lg:tw-px-8">
        <div className="tw-mx-auto tw-max-w-3xl tw-py-16 md:tw-py-24 lg:tw-py-36">
          <div className="tw-text-center">
            <h1 className="gradient-color tw-text-4xl tw-font-bold tw-tracking-tight tw-text-gray-900 sm:tw-text-6xl">
